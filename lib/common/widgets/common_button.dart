...
import 'package:rss_news_app/common/widgets/bouncing_button.dart';
                ...
                : Row(
                    children: [
                      ...
                      Expanded(
                        child: centerTitle
                            ? Center(
                                child: text.w(500).s(14).c(color).copyWith(
                                      maxLines: 1,
                            ...
                            : Padding(
                                ...
                                child: text.w(500).s(18).c(color).copyWith(
                                      maxLines: 1,
                                      overflow: TextOverflow.ellipsis,
                                    ),
                              ),
    ...
    return Container(
      ...
      child: Bouncing(
        ...
        child: Container(
          ...
          child: _child(
            enabled ? textColor ?? StaticColors.white : context.colors.primary,
          ),
        ),
      ),
    );
        ...
        children: [
          Flexible(
              child: text
                  .w(500)
                  .s(14)
                  .c(textColor ?? context.colors.primary)
