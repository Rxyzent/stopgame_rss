...
import 'package:rss_news_app/common/gen/fonts.gen.dart';
...
extension TextStringExtensions on String {
  ...
  Text f(String fontFamily) => Text(this).f(fontFamily);
...
extension TextExtensions on Text {
  ...
  Text h(double value) => copyWith(
    style: (style ?? const TextStyle()).copyWith(height: value/16),
  );
  ...
  //         fontFamily: style?.fontFamily ?? FontFamily.display,
  //         color: style?.color,
  //         overflow: overflow,
  //       ),
  //     );
