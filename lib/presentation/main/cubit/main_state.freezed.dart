...
abstract class $MainBuildableCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool themeMode, bool connection, String? language});
}
...
class _$MainBuildableImpl implements _MainBuildable {
  const _$MainBuildableImpl(
      {this.themeMode = true, this.connection = false, this.language});
  ...
  @override
  String toString() {
    return 'MainBuildable(themeMode: $themeMode, connection: $connection, language: $language)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, themeMode, connection, language);
...
mixin _$MainListenable {
  MainEffects get effect => throw _privateConstructorUsedError;

  /// Create a copy of MainListenable
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $MainListenableCopyWith<MainListenable> get copyWith =>
      throw _privateConstructorUsedError;
}
...
class __$$MainListenableImplCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_$MainListenableImpl(
      effect: null == effect
          ? _value.effect
          : effect // ignore: cast_nullable_to_non_nullable
              as MainEffects,
...
class _$MainListenableImpl implements _MainListenable {
  const _$MainListenableImpl({required this.effect});

  @override
  final MainEffects effect;

  @override
  String toString() {
    return 'MainListenable(effect: $effect)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$MainListenableImplCopyWith<_$MainListenableImpl> get copyWith =>
      __$$MainListenableImplCopyWithImpl<_$MainListenableImpl>(
          this, _$identity);
}

abstract class _MainListenable implements MainListenable {
  const factory _MainListenable({required final MainEffects effect}) =
      _$MainListenableImpl;

  @override
  MainEffects get effect;
