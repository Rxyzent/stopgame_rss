...
class _$SplashBuildableImpl implements _SplashBuildable {
  const _$SplashBuildableImpl({this.loading = true, this.error = false});
  ...
  @override
  String toString() {
    return 'SplashBuildable(loading: $loading, error: $error)';
  }
...
abstract class _SplashBuildable implements SplashBuildable {
  const factory _SplashBuildable({final bool loading, final bool error}) =
